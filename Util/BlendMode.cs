...
namespace UGXP.Util
{
	...
	public class BlendMode
	{
		...
		public static readonly BlendMode NORMAL = new BlendMode (
			"Normal", () => {	LegacyGL.BlendFunc(LegacyGL.SRC_ALPHA, LegacyGL.ONE_MINUS_SRC_ALPHA);	}
		);
		...
		public static readonly BlendMode PREMULTIPLIED = new BlendMode(
			"Premultiplied", () => { LegacyGL.BlendFunc(LegacyGL.ONE, LegacyGL.ONE_MINUS_SRC_ALPHA); }
		);
		...
		public static readonly BlendMode MULTIPLY = new BlendMode (
			"Multiply", () => {	LegacyGL.BlendFunc(LegacyGL.DST_COLOR, LegacyGL.ZERO);	}
		);
		...
		public static readonly BlendMode LIGHTING = new BlendMode(
			"Lighting", () => { LegacyGL.BlendFunc(LegacyGL.DST_COLOR, LegacyGL.ONE); }
		);
		...
		public static readonly BlendMode ADDITIVE = new BlendMode(
			"Additive", () => { LegacyGL.BlendFunc(LegacyGL.ONE, LegacyGL.ONE); }
		);
		...
		public static readonly BlendMode FILLEMPTY = new BlendMode(
			"Fill", () => { LegacyGL.BlendFunc(LegacyGL.ONE_MINUS_DST_ALPHA, LegacyGL.DST_ALPHA); }
		);
