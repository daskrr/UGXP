/* 
 * Taken from https://gist.github.com/dcronqvist/8e0c594532748e8fc21133ac6e3e8514
 * All (except marked modifications) are courtesy of dcronqvist
 */
...
namespace OpenGL {
    ...
    public static unsafe partial class GL {
        ...
        public static void glMatrixMode(int mode) => _glMatrixMode(mode);
        ...
        // GL_PERSPECTIVE_CORRECTION ADDED
        ...
        // MATRIX MODE ADDITION
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        private delegate void PFNGLMATRIXMODE(int mode);
        ...
        // ADDED MATRIX MODE
        private static PFNGLMATRIXMODE _glMatrixMode;
		...
		public static void Import(GetProcAddressHandler loader) {
            ...
            // ADDED MATRIX MODE
            _glMatrixMode = Marshal.GetDelegateForFunctionPointer<PFNGLMATRIXMODE>(loader.Invoke("glMatrixMode"));
